...
- [Installation Hosting](#install-on-hosting)
- [Installation VPS](#install-locally-or-in-vps)
...
- The default admin account is `thesky9` - `159357`.
...
- Run web locally:
    ...
    - Go to `/admin` to access to admin panel.
    - If you're using sample data, the default admin account is `thesky9` - `159357`.
